                    ...
                    <ul class="latest-news">
                        ...
                        <li>
                            ...
                            <div class="thumbnail-content">
                                <h5>DigiDev merupakan jasa pembuatan website profesional dan berkualitas terbaik. Kami melayani jasa pembuatan Toko Online, Web Profile, Web Pulsa Elektrik, Web PPOB, Web Sekolah, Web Instansi, Web Rumah Sakit, Web Jejaring Sosial, Web Iklan baris, dll.</h5>
                            </div>
                            <!-- .thumbnail-content -->
                        </li>
                        <?php } ?>
...
<div class="row">
    <div class="footer-bottom">
        <div class="copyright-txt">
            <p>&copy;  <a href="<?php echo base_url() ?>" title="DigiDev">DigiDev</a> <?php echo date('Y') ?>.</p>
        </div>
        <!-- .copyright-txt -->
