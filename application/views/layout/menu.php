...
<nav class="navbar">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav">
            ...
            <!-- berita -->
            <li><a href="#feature" class="nav-link scrollto">FEATURE</a></li>

            <!-- berita -->
            <li><a href="#portfolio" class="nav-link scrollto">PORTFOLIO</a></li>

            <!-- berita -->
            <li><a href="#aboutus" class="nav-link scrollto">ABOUT US</a></li>

            <!-- berita -->
            <li><a href="#package" class="nav-link scrollto">PACKAGE</a></li>
